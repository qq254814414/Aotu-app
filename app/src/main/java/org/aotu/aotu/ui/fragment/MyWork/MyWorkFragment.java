...
public class MyWorkFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("我的工作");
    ...
    private void initView(View view){
        tabLayout = view.findViewById(R.id.tl_my_work);
        viewPager = view.findViewById(R.id.vp_content);
    }

    private class TabFragmentPagerAdapter extends FragmentPagerAdapter {
        private final String[] titles = { "工作计划", "近期会议" };
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 1:
                    return new RecentMeetingFragment();
            }
            return null;
        }
